    ...
    <footer className="footer--container">
      <div className="footer--link--container">
        <div className = "footer--icon">
          <img src = "logo.svg" alt = "Aryan Gupta" style={{width: "7.5%", height: "7.5%"}}/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://www.instagram.com/aryangupta279"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/aryangupta0102/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href = "https://drive.google.com/file/d/1J1yFZATeR6sxBMH143N0Vv1WXLmYM8aI/view?usp=drive_link"
                className = "navbar--content"
                target = "_blank"
                rel="noreferrer"
              >
